...
// launch("cn.xuexi.android"); // 打开学习强国
// launch("com.tencent.mm"); // 打开学习强国
launchApp("学习强国");
sleep(7000);
toast('program is running');
sleep(3000);
...
click(330, 2080); // 刷新百灵
sleep(3000);
click(random(300, 800), random(350, 900)); // 随机打开一个视频
minute = random(18, 20);
second = random(1, 59);
toast('minute:' + minute + ' second:' + second);
...
for (var i = 0; i < 2; i++) {
    ...
    sleep(3000);
    click(random(300, 800), random(500, 700)); // 随机点开
    sleep(3000);
    click(random(110, 580), random(2070, 2130)); // 点开评论
    sleep(3000);
    setText(comment[random(0, comment.length)]); // 评论
    sleep(3000);
    click("发布"); // 点击发布
    sleep(3000);
