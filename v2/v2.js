...
//     sleep(2000)
// }
var videoNum = 6; // 观看几个视频
var videoTimeInMinute = 6; // 视频观看几分钟
...
for (var i = 0; i < videoNum; i++) {
    ...
    swipe(random(300, 800), random(1600, 2000), random(300, 800), random(300, 700), random(1500, 2000)) // 上滑切换
}
...
for (var i = 0; i < articleNum; i++) {
    ...
    if (i < articleCommentNum) {
        ...
        sleep(random(110, 160) * 100); // 阅读11~16秒
    } else {
        sleep(random(300, 360) * 1000); // 最后一篇文章阅读5~6分钟
    }
    back(); // 返回学习强国首页
    sleep(3000);
}
